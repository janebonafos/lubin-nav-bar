...
export const Route = createFileRoute("/check-in")({
  head: () => ({
    meta: [
      { title: "Daily check-in — Lubin" },
      { name: "description", content: "A gentle daily check-in." },
    ],
  }),
...
function CheckInPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-lavender/60 px-4 py-10 md:py-14">
      <div className="relative mx-auto w-full max-w-[640px]">
        ...
        <div className="mt-8 overflow-hidden">
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              {step === 3 && <Step3 summary={summarySentence} />}
            </motion.div>
          </AnimatePresence>
        </div>
        ...
        <div className="mt-10 text-center">
          <button
            onClick={() => navigate({ to: "/my-health-passport" })}
