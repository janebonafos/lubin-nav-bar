    ...
    >
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex items-center gap-4 shrink-0">
          <a
            href="/register"
            className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-brand-purple to-brand-purple-dark px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-brand-purple-dark"
          >
  ...
  return (
    <div className="grid gap-5">
      ...
      <Card className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <button
          onClick={onLogMood}
          className="inline-flex items-center justify-center gap-1.5 rounded-full bg-gradient-to-r from-brand-purple to-brand-purple-dark px-5 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-brand-purple-dark"
        >
  ...
  return (
    <Card className="relative overflow-hidden">
      ...
      <div className="relative text-center py-8 max-w-md mx-auto">
        ...
        <a
          href="/register"
          className="mt-5 inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-brand-purple to-brand-purple-dark px-5 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-brand-purple-dark"
        >
          Create account <span aria-hidden>→</span>
        </a>
      </div>
      ...
      <div className="mt-6 flex items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="rounded-full bg-gradient-to-r from-brand-purple to-brand-purple-dark px-5 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-brand-purple-dark disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Save
          </button>
        </div>
