              ...
              <>
                ...
                >
                  <div className="flex items-center gap-5">
                    <div className="relative">
                      <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-gradient-to-tr from-[#7E6BAF] to-[#A89BD0] text-2xl font-semibold text-white">
                        {profile.avatar ? (
                          <img
                            src={profile.avatar}
                            alt={displayName}
                    ...
                    <label
                      ...
                      className="inline-flex cursor-pointer items-center gap-1.5 text-sm font-semibold text-[#7E6BAF] transition hover:text-[#3D2E6B]"
                    >
                ...
                {/* Security */}
                <Card title="Security & Account Settings">
                  <Row
                    ...
                    action={
                      <button
                        type="button"
                        className="text-sm font-semibold text-[#7E6BAF] transition hover:text-[#3D2E6B]"
                      >
                        Change Password
                      </button>
                    }
                ...
                <Card title="Connected Accounts">
                  <Row
                    icon={
                      <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#EA4335] text-[11px] font-bold text-white">
                        G
                      </span>
                    }
                    title="Google Account"
                    subtitle={googleConnected ? "Linked" : "Not linked"}
                    action={
                      googleConnected ? (
                        <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#5BAF7E]">
                  ...
                  <Row
                    ...
                    subtitle={facebookConnected ? "Linked" : "Not linked"}
                    action={
                      facebookConnected ? (
