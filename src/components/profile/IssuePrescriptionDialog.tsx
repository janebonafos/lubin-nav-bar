...
export default function IssuePrescriptionDialog({
  ...
  function closeAsDraft() {
    // Only save a draft when the patient is identifiable — a prescription
    // without a patient name is discarded instead of creating an
    // "Unnamed patient" draft.
    const hasStarted = Boolean(patientName.trim() || selected?.fullName?.trim());
                      ...
                      {soapApproved ? (
                        ...
                        <div className="space-y-1.5">
                          <button
                            ...
                            className="flex h-11 w-full items-center justify-center gap-2 rounded-[12px] border border-[#3D2E6B] bg-white px-4 text-[13px] font-semibold text-[#3D2E6B] shadow-sm transition hover:bg-[#3D2E6B] hover:text-white"
                          >
