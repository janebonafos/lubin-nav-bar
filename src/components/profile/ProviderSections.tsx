...
export function AppointmentsSection() {
  ...
  const seed: Appt[] = [
    ...
    {
      id: "c9", client: "Miguel Santos", day: "SUN", date: "30", month: "AUG", time: "4:00 PM", timezone: "PHT (GMT+8)", duration: "30 min", type: "Psychiatry consultation (medication review)", sessionFormat: "Individual", mode: "Video", status: "session_review",
